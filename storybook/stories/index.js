...
storiesOf('Datatable', module)
  ...
  .add(
    'Multiple values for horizontal with no favourites in (undefined)',
    () => <DataTableStory data={exampleTableData} horizontal={true} />,
  )
  .add('Multiple values for vertical with no favourites in (undefined)', () => (
    <DataTableStory data={exampleTableData} horizontal={false} />
  ))
  .add('Multiple values for vertical with some favourites in', () => (
    <DataTableStory
      data={exampleTableData}
      favouriteStoreIds={[exampleTableData[0].id, exampleTableData[2].id]}
      horizontal={false}
    />
  ))
  .add('Multiple values for vertical with all favourites in', () => (
    <DataTableStory
      data={exampleTableData}
      favouriteStoreIds={exampleTableData.map(data => data.id)}
      horizontal={false}
    />
  ))
  .add('Multiple values for horizontal with some favourites in', () => (
    <DataTableStory
      data={exampleTableData}
      favouriteStoreIds={[exampleTableData[0].id, exampleTableData[2].id]}
      horizontal={true}
  ...
  .add('Multiple values for horizontal with all favourites in', () => (
    <DataTableStory
      data={exampleTableData}
      favouriteStoreIds={exampleTableData.map(data => data.id)}
      horizontal={true}
  ...
  .add(
    'Multiple values for veritcal with no favourites in (empty array)',
    () => (
      <DataTableStory
        data={exampleTableData}
        favouriteStoreIds={[]}
  ...
  .add(
    'Multiple values for veritcal with no favourites that exist within the returned data results',
    () => (
      <DataTableStory
        data={exampleTableData}
        favouriteStoreIds={[
          '__RANDOM__',
          '__ANOTHER_NO_EXIST__',
          '__AND_AGAIN',
        ]}
        horizontal={false}
      />
  ...
  .add(
    'Multiple values for veritcal with some favourites that exist within the returned data results but not all',
    () => (
      <DataTableStory
        data={exampleTableData}
        favouriteStoreIds={[
          exampleTableData[1].id,
          exampleTableData[3].id,
          '__RANDOM__',
          '__ANOTHER_NO_EXIST__',
          '__AND_AGAIN',
        ]}
  ...
  .add('Multiple values for undefined (veritcal default) alignment', () => (
    <DataTableStory data={exampleTableData} />
  ))
  .add('Single values for veritcal', () => (
    <DataTableStory data={[exampleTableData[0]]} horizontal={false} />
  ))
  .add('Single values for horizontal', () => (
    <DataTableStory data={[exampleTableData[0]]} horizontal={true} />
  ))

  .add('No values', () => <DataTableStory data={[]} />);
